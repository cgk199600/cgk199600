...
layui.define(["element","jquery"],function(exports){
    ...
    //生成左侧菜单
    Tab.prototype.navBar = function(strData){//获取到datastr数据便利
        var data;
	...
	Tab.prototype.render = function() {
		//显示左侧菜单
		var _this = this;
		$(".navBar ul").html('<li class="layui-nav-item layui-this"><a data-url="page/main.html"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a></li>').append(_this.navBar(dataStr)).height($(window).height()-210);//无论选什么菜单都会展示后台菜单
